...
const emailLib = require('./../libs/nodemailerLib');
...
let getAllPrivateListsFunction = (req, res) => {
    ...
    let findLists = () => {
        return new Promise((resolve, reject) => {
            ...
            ListModel.find({ 'listCreatorId': req.params.userId, listMode: 'private'})
                .select()
                .lean()
...
module.exports = {
    ...
    getAllPrivateListsFunction: getAllPrivateListsFunction,
